...
<<<<<<< HEAD
    >> MapAt[f, {a, b, c, d}, -1]
     = {a, b, c, f[d]}
=======
>>>>>>> 3aa6e07b... Start MapAt
=======
    >> MapAt[f, {a, b, c, d}, -1]
     = {a, b, c, f[d]}
>>>>>>> 2652f5c4... One more test
=======
    ...
    >> MapAt[f, <|"a" -> 1, "b" -> 2, "c" -> 3, "d" -> 4|>, -3]
     = {a -> 1, b -> f[2], c -> 3, d -> 4}
<<<<<<< HEAD
>>>>>>> 0be88345... Handle MapAt with associations
=======

    Use the operator form of MapAt:
    >> MapAt[f, 1][{a, b, c, d}]
     = {f[a], b, c, d}
>>>>>>> 2294b7bd... Add operator form of MapAt
    """
...
=======
        ...
        if isinstance(a, int):
            ...
            return List(*new_leaves)
>>>>>>> 6c063efb... MapAt with multiple positions...
